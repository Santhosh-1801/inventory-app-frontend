...
import Card from "../../card/Card"
 ...
 const ProductForms = ({product,productImage,imagePreview,description,setDescription,handleInputChange,handleImageChange,saveProduct}) => {
  return (
    ...
    <Card cardClass={"group"}>
        ...
        <input
            ...
            />
            {imagePreview!=null?(<div className='image-preview'><img src={imagePreview} alt='The Product'></img></div>):(<p>No image for this product</p>)
    ...
    <ReactQuill theme="snow" value={description} onChange={setDescription} modules={ProductForms.modules} formats={ProductForms.formats} />
    <div className='--my'>
